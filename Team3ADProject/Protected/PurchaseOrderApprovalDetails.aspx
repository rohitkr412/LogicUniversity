...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <table width="500">
       <tr> 
       <td>
          <b> Employee Name:</b> <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>

        </td>
        <td>
            <b>PO No.</b> <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Height="133px" Width="1000px">
        <Columns>
            <asp:BoundField DataField="description" HeaderText="Item Description"/>
            <asp:BoundField DataField="item_required_date" HeaderText="Required Date" DataFormatString="{0:MM/dd/yyyy}"/>
