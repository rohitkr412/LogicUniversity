...
namespace Team3ADProject.Protected
{
    public partial class ViewCollectionInformation : System.Web.UI.Page
    {
        ...
        protected void gridview1_SelectedIndexChanging(object sender,GridViewSelectEventArgs e)
        {
            ...
            Session["CollectionDate"] = gridview1.Rows[e.NewSelectedIndex].Cells[3].Text;
            Session["CollectionLocation"] = gridview1.Rows[e.NewSelectedIndex].Cells[4].Text;
            Session["CollectionTime"] = gridview1.Rows[e.NewSelectedIndex].Cells[5].Text;
            Session["disbursement_list_id"] = gridview1.Rows[e.NewSelectedIndex].Cells[6].Text;
